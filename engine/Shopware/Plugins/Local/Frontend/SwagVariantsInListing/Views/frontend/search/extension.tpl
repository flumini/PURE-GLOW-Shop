	...
	{if $sSearchResults.sArticles}
		...
		<div class="grid_13 first last">
			...
			<div class="listing" id="listing">
	        	...
	        	{include file='frontend/search/box_article_search.tpl' sTemplate='listing' articleimg1=$sArticles.$i.swagVariantsInListing.0 articleimg2=$sArticles.$i.swagVariantsInListing.1}
	        	{$i = $i+1}
