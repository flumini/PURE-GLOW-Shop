...
class Shopware_Plugins_Frontend_SwagCookiePermission_Bootstrap extends Shopware_Components_Plugin_Bootstrap
{
    ...
    protected function createConfigForm()
    {
        ...
        $form->setElement(
            ...
            array(
                'label' => 'Mode:',
                'store' => array(
                    array($this->getAskLaterMode(), 'Ask later'),
                    array($this->getRemoveCookiesMode(), 'Remove cookies')
                ),
                'required' => true
            )
        );
        ...
        $form->setElement(
            ...
            array(
                'label' => 'Enable for:',
                'store' => array(
                    array($this->getEveryone(), 'Everyone'),
                    array($this->getDetectByIp(), 'GEO-IP detection'),
                    array($this->getDetectByBrowserLanguage(), 'Browser language detection'),
                    array($this->getDetectByShopLanguage(), 'Shop language detection')
                ),
                'required' => true,
                'multiSelect' => true
            )
    ...
    public function createTranslations()
    {
        ...
        $translations = array(
            'en_GB' => array(
                'swagCookieMode' => 'Mode:',
                'swagCookieAppliesTo' => 'Enable for:',
                'swagCookieLanguage' => 'Language:',
                'swagCookieForwardTo' => 'Forward to URL:',
                'swagCookieCountry' => 'Country:',
                'swagCookieColor' => 'Color:',
            ),
            'de_DE' => array(
                'swagCookieMode' => 'Modus:',
                'swagCookieAppliesTo' => 'Aktivieren für:',
                'swagCookieLanguage' => 'Sprache:',
                'swagCookieForwardTo' => 'Weiterleiten zu URL:',
                'swagCookieCountry' => 'Land:',
                'swagCookieColor' => 'Farbe:',
            )
        );
