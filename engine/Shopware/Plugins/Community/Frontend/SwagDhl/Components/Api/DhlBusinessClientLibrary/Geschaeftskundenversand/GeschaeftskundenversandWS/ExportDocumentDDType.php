...
class ExportDocumentDDType
{
   ...
   * @access public
   */
  public function __construct($InvoiceType, $InvoiceDate, $InvoiceNumber, $ExportType, $ExportTypeDescription, $CommodityCode, $TermsOfTrade, $Amount, $Description, $CountryCodeOrigin, $AdditionalFee, $CustomsValue, $CustomsCurrency, $PermitNumber, $AttestationNumber, $WithElectronicExportNtfctn, $ExportDocPosition)
  {
