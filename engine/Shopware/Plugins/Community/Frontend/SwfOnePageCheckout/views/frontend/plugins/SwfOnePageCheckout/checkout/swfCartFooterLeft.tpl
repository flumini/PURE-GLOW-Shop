{namespace name="frontend/checkout/cart_footer_left"}

<div class="grid_9 box">
	
	{block name='frontend_checkout_table_footer_left_add_voucher'}
		<div class="vouchers">
			<form method="post" action="{url action='addVoucher' sTargetAction=confirm part=cart}">
		...
		<div class="add_article">
			<form method="post" action="{url action='addArticle' sTargetAction=confirm part=cart}">
