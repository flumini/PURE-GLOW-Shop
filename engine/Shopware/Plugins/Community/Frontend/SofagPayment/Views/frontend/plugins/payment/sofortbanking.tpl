...
{/if}
    {if $sofortSofortbankingIsShowingBanner}
        {if $sofortSofortbankingIsCustomerProtectionEnabled}
            <a href = "{$sofortSofortBankingLinkBannerCustomerProtection}" target = "_blank" ><img
                        src = '{$sofortSofortbankingBannerCp}' alt = '{$sofortSofortbankingAlt}' /></a >


                                        {else}


            <a href = "{$sofortSofortBankingLinkBannerLogo}" target = "_blank" ><img
                        src = '{$sofortSofortbankingBanner}' alt = '{$sofortSofortbankingAlt}' /></a >
        {/if}
    {/if}
    {if $sofortSofortbankingIsShowingLogo}
        <a href = "{$sofortSofortBankingLinkBannerLogo}" target = "_blank" ><img src = '{$sofortSofortbankingLogo}'
                                                                                 alt = '{$sofortSofortbankingAlt}' /></a >
