<?php
     ...
     */
    class Shopware_Plugins_Frontend_SofagPayment_Components_Helpers_OptionHelper
    {
        /**
        ...
        {
            if ( trim( Shopware()->Plugins()->Frontend()->SofagPayment()->Config()->get( "option_" . $name ) )
                 === null
            ) {
                ...
                return trim( Shopware()->Plugins()->Frontend()->SofagPayment()->Config()->get( "option_" . $name ) );
            }
        }
