 ...
 * The Installer class
 */
class Shopware_Plugins_Frontend_SofagPayment_Components_Services_Setup
{
    ...
    private function _createTables()
    {
        ...
        's_user_attributes', 'sofag', 'ideal_bank', 'varchar(255)');
    ...
    private function _createConfig()
    {
        ...
        $form->setElement('button', 'option_lable_basic_settings',
            array(
                 'label' => '',
                 'text'  => '<b>Plugin Grundeinstellungen</b>',
            ));
        ...
        $form->setElement('boolean', 'option_general_remove_failed_transactions',
            array(
                 'label'       => 'Abgebrochene Zahlungen verwerfen',
                 'description' => 'Bestellungen mit abgebrochener Bezahlung werden nicht gespeichert.',
                 'required'    => false,
                 'value'       => false
            ));
        ...
        $form->setElement('button', 'option_lable_settings_sofortbanking',
            array(
                 'label' => '',
                 'text'  => '<b>Einstellungen: SOFORT Überweisung</b>',
            ));
        ...
        $form->setElement('button', 'option_lable_settings_sofortbanking_states',
            array(
                 'label' => '',
                 'text'  => '<b>Ordnen Sie im Folgenden Statusänderungen bei SOFORT den Bestellstatus Ihres Shops zu:</b>',
            ));
        ...
        $form->setElement('button', 'option_lable_settings_ideal_states',
            array(
                 'label' => '',
                 'text'  => '<b>Ordnen Sie im Folgenden Statusänderungen bei iDEAL den Bestellstatus Ihres Shops zu:</b>',
            ));
    ...
    private function _createEvents()
    {
        ...
        $this->_bootstrap->subscribeEvent('Shopware_Controllers_Frontend_Account::savePaymentAction::before',
            'onSavePayment');
        $this->_bootstrap->subscribeEvent('Shopware_Controllers_Frontend_Account::savePaymentAction::before',
            'onSavePayment');
        $this->_bootstrap->subscribeEvent('Enlight_Controller_Action_PostDispatch', 'onPostDispatch');
        $this->_bootstrap->subscribeEvent('Enlight_Controller_Dispatcher_ControllerPath_Frontend_PaymentSofortbanking',
            'registerSofortbankingController');
        $this->_bootstrap->subscribeEvent('Enlight_Controller_Dispatcher_ControllerPath_Frontend_PaymentIdeal',
            'registerIdealController');
        $this->_bootstrap->subscribeEvent('Enlight_Controller_Dispatcher_ControllerPath_Backend_SofagLogView',
            'registerAdminViewLogController');
    }
    ...
    {
        $languages = array();
        $csv = new Shopware_Plugins_Frontend_SofagPayment_Components_Services_Csv();
        $helper = new Shopware_Plugins_Frontend_SofagPayment_Components_Helpers_Helper();
        ...
        try {
            foreach ($translations as $locale => $snippets) {
                ...
                array_walk($snippets, array(Shopware_Plugins_Frontend_SofagPayment_Components_Helpers_DatabaseHelper,
    ...
    private function _cleanDb()
    {
        ...
        try {
            ...
            's_user_attributes', 'sofag', 'ideal_bank'
            );
