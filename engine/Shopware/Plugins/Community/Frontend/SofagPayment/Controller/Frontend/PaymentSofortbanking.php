<?php
        ...
        extends Shopware_Plugins_Frontend_SofagPayment_Controller_Frontend_PaymentAbstract
    {
        ...
        public function gatewayAction()
        {
            ...
            $sofort->setLogger( new Shopware_Plugins_Frontend_SofagPayment_Components_Services_Logger() );
            ...
            $sofort->setVersion( "ShopWare4_" . Shopware()->Plugins()->Frontend()->SofagPayment()->getVersion() );
            $sofort->sendRequest();
            //Validate Data
            if ( $sofort->isError() ) {
                $this->redirect( array(
            ...
            Shopware()->Session()->sofagTransactionId = $sofort->getTransactionId();
        ...
        public function notifyAction()
        {
            ...
            $notification->setLogger( new Shopware_Plugins_Frontend_SofagPayment_Components_Services_Logger() );
